...
- 푸터는 저작권 문구와 `We make better solvers.`를 표시한다.
...
| 순서 | 라벨         | 영문 제목                   | 이동         |
| ---- | ------------ | --------------------------- | ------------ |
| 01   | 소개         | `We make better solvers.`   | 소개         |
| 02   | 대회         | `We host competitions.`     | 대회         |
| 03   | 연혁         | `Our solvers, our results.` | 연혁         |
| 04   | 가입 및 문의 | `Join Solvers.`             | 가입 및 문의 |

### 6.2 소개

첫 문장은 다음 내용을 사용한다.

> Solvers는 한신대학교 알고리즘 소모임으로,<br>
> 다음과 같은 활동을 하고 있습니다.

활동은 세 문단으로 구성한다.

1. **스터디:** 매주 알고리즘과 자료구조를 학습하고 다양한 문제를 함께 풀며 풀이 방법을 익힌다.
2. **대회 개최:** 매년 봄과 가을에 교내 알고리즘 대회를 개최하며 대회 화면으로 연결한다.
3. **대회 참여:** 구성원이 외부 알고리즘 대회에 참가한다.
...
| 기간           | 일시                             | 장소                                  | 이미지                             |
| -------------- | -------------------------------- | ------------------------------------- | ---------------------------------- |
| `2026: Fall`   | 10월 중 예정                     | 한신대학교 장준하통일관 예정          | 대회 포스터 공개 시 추가           |
| `2026: Spring` | 2026. 05. 29. (금) 14:30 ~ 18:00 | 한신대학교 장준하통일관(18관) 18422호 | `/images/contests/2026-spring.png` |

2026 Fall은 Solvers의 첫 공식 교내 알고리즘 대회이며 표어로 `Detect, Think, Solve,`를 사용한다.
...
| 직책     | 이름   | 연락처            |
| -------- | ------ | ----------------- |
| 소모임장 | 김성수 | `4thrun@hs.ac.kr` |

현재 외부 대회 성적:

| 날짜                  | 대회           | 결과  |
| --------------------- | -------------- | ----- |
| 26.06.27.             | UCPC 2026 예선 | 122nd |
| 26.06.29. ~ 26.07.09. | NYPC 2026 예선 | 31st  |
| 26.08.02.             | ACPC 2026 본선 | 68th  |

### 6.5 가입 및 문의

- 가입 신청: [Google Forms](https://forms.gle/2D38E2w3D4FbQcW17)
- 문의 담당자: IT영상콘텐츠학과 김성수
- 문의 이메일: `4thrun@hs.ac.kr`
- 가입 신청 링크는 외부 이동 표시와 함께 제공한다.
- 담당자와 이메일은 가로 공간에 맞춰 한 줄 또는 여러 줄로 배치한다.

## 7. 콘텐츠 관리

Astro Content Collections와 Markdown 파일을 사용한다.
